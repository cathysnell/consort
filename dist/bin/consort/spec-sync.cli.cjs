...
function validateSpec(consortDir) {
  ...
  const wsPath = (0, import_path2.join)(consortDir, "workflow-state.json");
  ...
  for (const featureDirName of (0, import_fs2.readdirSync)(featuresDir2)) {
    ...
    const storiesDir2 = (0, import_path2.join)(featureDir, "stories");
    if (!(0, import_fs2.existsSync)(storiesDir2)) continue;
    for (const storyDirName of (0, import_fs2.readdirSync)(storiesDir2)) {
      const storyDir = (0, import_path2.join)(storiesDir2, storyDirName);
