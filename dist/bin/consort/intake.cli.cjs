...
function checkIntakePreconditions(args = {}) {
  ...
  const projectDir = args.projectDir ?? (0, import_node_path2.dirname)(consortDir);
  const uiTrack = resolveProjectSettings(projectDir).project.uiTrack;
  const required = [
    { artifact: "product-overview.md", path: (0, import_node_path2.join)(consortDir, "product-overview.md") },
    { artifact: "nfrs.md", path: (0, import_node_path2.join)(consortDir, "nfrs.md") }
  ];
  if (uiTrack) {
    required.push({ artifact: "design-brief.md", path: (0, import_node_path2.join)(consortDir, "design", "design-brief.md") });
  }
  if (args.featureId) {
