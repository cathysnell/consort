  ...
  return {
    ...
    stories: {
      "S2-submit-create-bug": {
        gateApproved: false,
        gateSurfaced: false,
        design: { hasAcs: true, architectAnnotated: true, architectProjectable: false, dbaDesigned: false, testListReady: false, reflectionPassed: false, reflectionVerdictWritten: false },
        build: {
          experimentCut: false,
          testsWritten: false,
          codeWritten: false,
...
describe("expectationFor: each role handoff declares its non-null return contract", () => {
  ...
  it("spec-author / architect-reviewer per-story contracts map to their DriveState advance", () => {
    ...
    noAcs.stories["S2-submit-create-bug"].design = { hasAcs: false, architectAnnotated: false, architectProjectable: false, dbaDesigned: false, testListReady: false, reflectionPassed: false, reflectionVerdictWritten: false };
...
describe("ExpectationLedger.processCallback: caller-identity intake (multi-threaded-ready)", () => {
  ...
  function twoStoryState(over: { s1HasAcs?: boolean; s2ListReady?: boolean } = {}): DriveState {
    ...
    s.stories["S1"] = {
      gateApproved: false,
      gateSurfaced: false,
      design: { hasAcs: over.s1HasAcs ?? false, architectAnnotated: false, architectProjectable: false, dbaDesigned: false, testListReady: false, reflectionPassed: false, reflectionVerdictWritten: false },
